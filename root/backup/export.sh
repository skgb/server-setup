...
# DON'T encrypt database dumps
# The monolithic backup file is encrypted instead, which is easier to use.
tar -rf "$BACKUPFILE" databases.tar
rm -f neo4jfulldump.cypher.bz2 postfix-virtual databases.tar
...
rm -Rf credentials.private.orig ssh le-archive le-accounts le-renewal serverconfig.tar serverconfig.tar.bz2
